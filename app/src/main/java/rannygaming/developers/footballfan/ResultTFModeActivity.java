...
public class ResultTFModeActivity extends AppCompatActivity {

    Button btvResult, btvErrors, btnNext;
    int trueReplys = ModeTFActivity15.counter;
    int errors;
    double result;
    int money;
    String stringResult;
    ...
    String login;
    String ServerURL = "https://rannygaming.ru/footballfanphp/insert_mode_tf.php" ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_result_tf_mode);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ResultTFModeActivity.this, RatingActivity.class);
