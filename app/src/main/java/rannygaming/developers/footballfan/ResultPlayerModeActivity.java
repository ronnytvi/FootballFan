...
public class ResultPlayerModeActivity extends AppCompatActivity {

    Button btvResult, btvErrors, btnNext;
    int trueReplys = ModePlayerActivity15.counter;
    int errors;
    double result;
    int money;
    String stringResult;
    ...
    String login;
    String ServerURL = "https://rannygaming.ru/footballfanphp/insert_mode_player.php" ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_result_player_mode);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ResultPlayerModeActivity.this, RatingActivity.class);
