...
public class ResultLogoModeActivity extends AppCompatActivity {

    Button btvResult, btvErrors, btnNext;
    int trueReplys = ModeLogoActivity15.counter;
    int errors;
    double result;
    int money;
    String stringResult;
    ...
    String login;
    String ServerURL = "https://rannygaming.ru/footballfanphp/insert_mode_logo.php" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ResultLogoModeActivity.this, RatingActivity.class);
